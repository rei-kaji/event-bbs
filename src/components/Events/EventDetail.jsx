    ...
    <div>
      ...
      >
        <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Event Image */}
          <CardMedia component='img' image={props.img} objectFit='contain' />
          {/* Event Info */}
          <CardContent sx={{ flexGrow: 1 }} style={{ paddingBottom: 0 }}>
            <Typography paragraph>
              <div className='event_info'>
                <div>
                  ...
                  <div className='event_info_adress'>
                    ...
                    <a target='_blank' href={props.adress_link}>
                      {props.adress}
                    </a>
                  </div>
              ...
              <div className='event_info_updatedate'>
